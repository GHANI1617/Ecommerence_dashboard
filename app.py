...
try:
    ...
    st.error(f"Error in Top Products plot: {str(e)}")
    raise
...
try:
    ...
    st.error(f"Error in Sales Over Time plot: {str(e)}")
    raise
...
try:
    ...
    st.error(f"Error in Country-wise Sales plot: {str(e)}")
    raise
...
try:
    ...
    st.error(f"Error in Quantity Distribution plot: {str(e)}")
    raise
...
try:
    ...
    st.error(f"Error in Business Recommendations: {str(e)}")
    raise
